...
void umat_elasticity_iso(const vec &, const vec &, vec &, mat &, const mat &, const int &, const vec &, const int &, vec &, const double &, const double &,const double &,const double &, double &, double &, const int &, const int &, const bool &);
