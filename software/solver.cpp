                                ...
                                if(nK == 0){
                                    ...
                                    for(int k = 0 ; k < 6 ; k++)
                                    {
                                        if (sptr_meca->cBC_meca(k)) {
                                            ...
                                            residual(k) = lambda*(DEtot(k) - Dtinc*sptr_meca->mecas(inc,k));
                                        }
                                    }
                                ...
                                if(nK + sptr_thermomeca->cBC_T == 0){
                                    ...
                                    for(int k = 0 ; k < 6 ; k++)
                                    {
                                        if (sptr_thermomeca->cBC_meca(k)) {
                                            ...
                                            residual(k) = lambda*(DEtot(k) - Dtinc*sptr_thermomeca->mecas(inc,k));
                                        }
                                    }
                                    if (sptr_thermomeca->cBC_T == 1) {
                                        ...
                                        residual(6) = lambda*(DT - Dtinc*sptr_thermomeca->Ts(inc));
                                    }
